    ...
    >
      ...
      <div className="grid gap-2 sm:grid-cols-2">
        <label className="flex flex-col gap-0.5">
          <span className="text-[11px] text-cs2-text-muted">玩家昵称关键词</span>
          <input
            id={`${idPrefix}-player`}
      ...
      <div className="mt-2 grid grid-cols-2 gap-2 sm:grid-cols-4">
        <label className="flex flex-col gap-0.5">
          <span className="text-[11px] text-cs2-text-muted">击杀 ≥</span>
          <input
            inputMode="numeric"
            disabled={!pq}
        ...
        <label className="flex flex-col gap-0.5">
          <span className="text-[11px] text-cs2-text-muted">死亡 ≤</span>
          <input
            inputMode="numeric"
            disabled={!pq}
            className="rounded border border-cs2-border bg-cs2-bg-input px-2 py-1.5 font-mono text-[12px] outline-none focus:border-cs2-accent/45 disabled:cursor-not-allowed disabled:opacity-40"
        ...
        <label className="flex flex-col gap-0.5">
          <span className="text-[11px] text-cs2-text-muted">助攻 ≥</span>
          <input
            inputMode="numeric"
            disabled={!pq}
            className="rounded border border-cs2-border bg-cs2-bg-input px-2 py-1.5 font-mono text-[12px] outline-none focus:border-cs2-accent/45 disabled:cursor-not-allowed disabled:opacity-40"
        ...
        <label className="flex flex-col gap-0.5">
          <span className="text-[11px] text-cs2-text-muted">KD ≥</span>
          <input
            inputMode="decimal"
            disabled={!pq}
            className="rounded border border-cs2-border bg-cs2-bg-input px-2 py-1.5 font-mono text-[12px] outline-none focus:border-cs2-accent/45 disabled:cursor-not-allowed disabled:opacity-40"
      ...
      <div className="mt-2 grid gap-2 sm:grid-cols-2">
        <div className="flex flex-col gap-0.5">
          <span className="text-[11px] text-cs2-text-muted">回合数范围</span>
        ...
        <div className="flex flex-col gap-0.5">
          <span className="text-[11px] text-cs2-text-muted">时长范围（分钟）</span>
          <div className="flex items-center gap-1">
            <input
              inputMode="decimal"
              className="min-w-0 flex-1 rounded border border-cs2-border bg-cs2-bg-input px-2 py-1.5 font-mono text-[12px] outline-none focus:border-cs2-accent/45"
