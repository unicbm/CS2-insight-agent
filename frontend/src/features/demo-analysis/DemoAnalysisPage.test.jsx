...
import DemoAnalysisPage from "./DemoAnalysisPage";
...
function renderPage(shell) {
  return render(
    <MemoryRouter>
      <AppShellProvider value={shell}><DemoAnalysisPage /></AppShellProvider>
    </MemoryRouter>,
  );
}

describe("DemoAnalysisPage Insight Agent flow", () => {
  beforeEach(() => {
